...
![](../../images/topics/Dashboards.Data_Filtering.Filters_1.png)

This chapter will cover the following:

[Filter editor]();

[Example of setting the filters of an element]().

[Table of filter operations]().
...
![](../../images/img_3.png) This parameter is used to determine the [logical operation]() in the data filtering condition.
...
Step 4: Define a [logical filter operation](). In this case, select the **equal to** operation.


Step 5: Select or enter the value of the filter condition. In this example, the category **Condiments** will be selected.


![](../../images/topics/Dashboards.Data_Filtering.Filters_5.png)
...
Step 7: Select this data field and select a [logical operation]() **between**;
...
![](../../images/topics/Dashboards.Data_Filtering.Filters_7.png)
