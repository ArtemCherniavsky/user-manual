...
![](../../images/topics/Dashboards.Data_Filtering.Data_Transformation_1.png)
...
Then, an editor will be opened in which you need to specify a value for the [logical operation](Filters.md). When this filter is triggered, fulfilling a certain logical condition, the values will be displayed.
...
The filter editor will be called. You should add filters, define a [logical operation](Filters.md) and value. When this filter is triggered, the values will be displayed.
...
![](../../images/topics/Dashboards.Data_Filtering.Data_Transformation_10.png)
