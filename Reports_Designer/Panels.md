...
[Properties]() - a panel displaying the properties of the selected element, their values, and associated events.

[Dictionary]() - a panel that displays all created data sources, variables, functions, and resources.

[Tree]() - a panel that shows the hierarchy of report components or dashboard elements.


You can enable or disable these panels in the Page tab under the [Panels control menu](Page_Tab.md). These panels can also be moved within the designer window. To do this:  
 Hover the mouse cursor over the panel title;

Press and hold the left mouse button and move the cursor without releasing it.


![](../images/topics/Reports_Designer.Panels_1.png)
