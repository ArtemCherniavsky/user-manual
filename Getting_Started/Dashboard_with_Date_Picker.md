...
Step 9: Define the type of work of the Date Picker element by setting the [Single mode]() value, [Range](), [Auto Range]() for the Selection Mode parameter.
...
![](../images/topics/Getting_Started.Dashboard_with_Date_Picker_5.png)
